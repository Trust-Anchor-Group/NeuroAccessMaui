...
namespace NeuroAccessMaui.UI.Pages.Wallet.MachineVariables
{
	...
	public partial class MachineVariablesViewModel : BaseViewModel
	{
		...
		private Task Wallet_StateUpdated(object? Sender, NeuroFeatures.Events.NewStateEventArgs e)
		{
		...
		private Task Wallet_VariablesUpdated(object? Sender, NeuroFeatures.Events.VariablesUpdatedEventArgs e)
		{
			MainThread.BeginInvokeOnMainThread(() =>
			{
