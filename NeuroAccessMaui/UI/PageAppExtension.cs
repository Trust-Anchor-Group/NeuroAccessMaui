...
using NeuroAccessMaui.Services.Ocr;
...
namespace NeuroAccessMaui.UI
{
	...
	public static class PageAppExtension
	{
		...
		public static MauiAppBuilder RegisterTypes(this MauiAppBuilder Builder)
		{
			...
			Builder.Services.AddSingleton<IOcrService>((_) => Types.InstantiateDefault<IOcrService>(false));
		...
		public static MauiAppBuilder RegisterPages(this MauiAppBuilder Builder)
		{
			...
			Builder.Services.AddTransient<NfcPage, NfcViewModel>();
