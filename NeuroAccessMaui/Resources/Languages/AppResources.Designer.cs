...
namespace NeuroAccessMaui.Resources.Languages {
    ...
    internal class AppResources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Enter your phone and email to request account recovery. We&apos;ll contact you with instructions to help you regain access..
        /// </summary>
        internal static string OnboardingContactSupportDetails {
            get {
                return ResourceManager.GetString("OnboardingContactSupportDetails", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to If you already have access to your account on another device, go to Settings → Transfer ID to generate a QR code. Then, scan that QR code on the previous page..
        /// </summary>
        internal static string OnboardingContactSupportInfo {
            get {
                return ResourceManager.GetString("OnboardingContactSupportInfo", resourceCulture);
            }
        }
