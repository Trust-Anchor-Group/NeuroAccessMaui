...
namespace NeuroAccessMaui.Services.Xmpp
{
	...
	public interface IXmppService : ILoadableService
	{
		...
		Task<(bool Succeeded, string? ErrorMessage, string[]? Alternatives)> TryConnect(string domain, bool isIpAddress, string hostName, int portNumber,
		...
		/// <param name="connectedFunc">A callback to use if and when connected.</param>
		/// <returns>If connected. If not, any error message.</returns>
		Task<(bool Succeeded, string? ErrorMessage, string[]? Alternatives)> TryConnectAndCreateAccount(string domain, bool isIpAddress, string hostName,
		...
		/// <param name="connectedFunc">A callback to use if and when connected.</param>
		/// <returns>If connected. If not, any error message.</returns>
		Task<(bool Succeeded, string? ErrorMessage, string[]? Alternatives)> TryConnectAndConnectToAccount(string domain, bool isIpAddress, string hostName,
		...
		Task<LegalIdentity> CompletePreviewLegalIdentity(CaseInsensitiveString legalIdentityId, params LegalIdentityAttachment[] Attachments);
		...
		event EventHandlerAsync<ItemNotificationEventArgs> ItemNotification;
		/// <summary>Raised when an item is retracted from a PubSub node.</summary>
		event EventHandlerAsync<ItemNotificationEventArgs> ItemRetracted;
		/// <summary>Raised when a PubSub node is purged.</summary>
		event EventHandlerAsync<NodeNotificationEventArgs> NodePurged;
		/// <summary>Raised when your subscription status changes for a node.</summary>
		event EventHandlerAsync<SubscriptionNotificationEventArgs> SubscriptionStatusChanged;
		/// <summary>Raised when a subscription request arrives for a node you own.</summary>
		event EventHandlerAsync<SubscriptionRequestEventArgs> SubscriptionRequest;
