...
namespace NeuroAccess.Nfc.Test
{
	...
	public class EfCardAccessTests
	{
		...
		[DataRow("")]
		public async Task Test_01_Parse(string Base64)
		{
			...
			{
				AppInfo = new ApplicationLevelInformation([], "0108", 1, 8, "040000", 4, 0, null),
